...
public class Timetabling {
	...
	long starttimeLargestDegree = System.nanoTime();
		...
		System.out.println("Fitness  	    : " + Evaluator.getPenalty(conflict_matrix, schedule.getSchedule(), jumlahmurid));
		System.out.println("Time(s)         :"+ ((double) (endtimeLargestDegree - starttimeLargestDegree)/1000000000) + " second(s).\n");
